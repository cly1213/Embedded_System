...
void init_systick_timer(uint32_t tick_hz)
{
	...
	// CVR copy to SVR
	// CVR 4 3 3 1 0
	// 0.0635 us delay = 1 count
	// 1 us delay = 16 count


    /* calculation of reload value */
    uint32_t count_value = (SYSTICK_TIM_CLK/tick_hz)-1;  //5-1

    //Clear the value of SVR
    *pSRVR &= ~(0x00FFFFFFFF);

    //load the (CVR) value in to SVR
    *pSRVR |= count_value;
...
__attribute__((naked)) void switch_sp_to_psp(void)
{
	...
	__asm volatile ("BL get_psp_value"); //go to this function
