...
int main(void)
{
	//1. Lets configure the priority for the peripherals
	 ...
	 configure_priority_for_irqs(IRQNO_I2C1,0x70); //0x80 change to 0x70
...
void TIM2_IRQHandler(void)
{
  ...
  *pNVIC_ISPRBase |= ( 1 << IRQNO_I2C1); //the I2C1 IRQ not priority than TIM2 so not execute.
  //if want to execute I2C1 IRQ, change priority value than TIMER2
  while(1);
